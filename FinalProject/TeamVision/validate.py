...
Usage:
python validate.py --model_path /home/SharedData/intern_sayan/PascalVOC2012/model_best.pth \
                    --gpu 1

    model_path and gpu are optional
...
if __name__ == "__main__":
    ...
    if os.path.exists(args.model_path):
        print("Loading trained model:", args.model_path)
        SAVED_MODEL_PATH = args.model_path
    else:
        print("Loading checkpoint_file:", checkpoint_file)
